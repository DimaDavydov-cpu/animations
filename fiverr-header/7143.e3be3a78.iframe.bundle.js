"use strict";
(self["webpackChunk_fiverr_private_penta_storybook"] = self["webpackChunk_fiverr_private_penta_storybook"] || []).push([[7143],{
...
/***/ "../layout_components/dist/esm/src/components/Stack/index.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
// EXTERNAL MODULE: ../layout_components/dist/esm/src/components/Flex/index.js
var Flex = __webpack_require__("../layout_components/dist/esm/src/components/Flex/index.js");
...
;// ../layout_components/dist/esm/src/components/Stack/constants.js
const PROPERTIES = {
  column: 'horizontal',
  row: 'vertical',
...
const Stack = /*#__PURE__*/(0,react.forwardRef)((_ref, ref) => {
  ...
  const withDividerChildren = (childrenElements, idx) => /*#__PURE__*/react.createElement(react.Fragment, null, childrenElements, idx < Number(childrenLength) - 1 ? /*#__PURE__*/react.createElement(Divider/* default */.A, _objectSpread({
    direction: dividerResponsiveDirection,
    height: dividerProps.variant === 'dot' ? undefined : 'auto'
  }, dividerProps)) : null);
  return /*#__PURE__*/react.createElement(Flex/* default */.A, _objectSpread({
    ref: ref,
    direction: direction,
    gap: gap,
...
//# sourceMappingURL=7143.e3be3a78.iframe.bundle.js.map