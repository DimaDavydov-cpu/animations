(self["webpackChunk_fiverr_private_penta_storybook"] = self["webpackChunk_fiverr_private_penta_storybook"] || []).push([[1419,6512],{
...
/***/ "../ui_utils/src/components/LazyComponent/stories/Docs.mdx":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _index_stories__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("../ui_utils/src/components/LazyComponent/stories/index.stories.tsx");
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_storybook_blocks__WEBPACK_IMPORTED_MODULE_3__/* .Meta */ .W8, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.p, {
        children: "Lazy-loading component wrapper * The imported component must be the default export of the module you are lazy-loading."
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.ul, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.li, {
          children: ["Use webpack's ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.a, {
            href: "https://webpack.js.org/api/module-methods/#magic-comments",
            target: "_blank",
            rel: "nofollow noopener noreferrer",
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
              children: "webpackChunkName"
            }), " magic comment"]
          }), " to\nseparate the lazy-loaded component from main bundle."]
        }), "\n"]
      })]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.pre, {
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        className: "language-tsx",
        children: "import { LazyComponent } from '@fiverr-private/ui_utils';\n"
      })
...
/***/ "../ui_utils/src/components/LazyComponent/stories/index.stories.tsx":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  WithComponentProps: () => (/* binding */ WithComponentProps),
  WithPlaceholder: () => (/* binding */ WithPlaceholder),
...
;// ../ui_utils/src/components/LazyComponent/index.tsx
...
const LazyComponent = _ref => {
  ...
  let {
    lazyImport,
    shouldImport = true,
    fallback = /*#__PURE__*/react.createElement(EmptyComponent, null),
    placeholder = /*#__PURE__*/react.createElement(EmptyComponent, null),
  ...
  const isImported = !(0,lodash.isNil)(componentRef.current);
  ...
  const latestImport = (0,useLatest/* default */.A)(lazyImport);
  const latestCallbacks = (0,useLatest/* default */.A)({
    beforeLoad,
    afterLoad,
    onError
  });
  ...
  return Component ? /*#__PURE__*/react.createElement(Component, componentProps) : fallback;
};
LazyComponent.displayName = 'LazyComponent';
/* harmony default export */ const components_LazyComponent = (LazyComponent);
try {
    // @ts-ignore
    LazyComponent.displayName = "LazyComponent";
    // @ts-ignore
    LazyComponent.__docgenInfo = { "description": "", "displayName": "LazyComponent", "props": { "lazyImport": { "defaultValue": null, "description": "The lazy import function, with webpack's magic comments.", "name": "lazyImport", "required": true, "type": { "name": "() => Promise<PromiseResult>" } }, "shouldImport": { "defaultValue": { value: "true" }, "description": "Controlled boolean from parent, that should be used for on-demend import.", "name": "shouldImport", "required": false, "type": { "name": "boolean", "value": [{ "value": "false" }, { "value": "true" }] } }, "fallback": { "defaultValue": { value: "<EmptyComponent />" }, "description": "The fallback component to be used when the lazy component fails to load.", "name": "fallback", "required": false, "type": { "name": "ReactElement<any, string | JSXElementConstructor<any>>" } }, "placeholder": { "defaultValue": { value: "<EmptyComponent />" }, "description": "The placeholder component to be used when the lazy component is loading.", "name": "placeholder", "required": false, "type": { "name": "ReactElement<any, string | JSXElementConstructor<any>>" } }, "beforeLoad": { "defaultValue": { value: "() => undefined" }, "description": "Function to be called before the component is loaded.", "name": "beforeLoad", "required": false, "type": { "name": "VoidFunction" } }, "afterLoad": { "defaultValue": { value: "() => undefined" }, "description": "Function to be called after the component has loaded.", "name": "afterLoad", "required": false, "type": { "name": "VoidFunction" } }, "onError": { "defaultValue": { value: "() => undefined" }, "description": "Function to be called when the component fails to load.", "name": "onError", "required": false, "type": { "name": "(error: unknown) => void" } }, "componentProps": { "defaultValue": null, "description": "Props to be passed to the component.", "name": "componentProps", "required": false, "type": { "name": "object" } } } };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../ui_utils/src/components/LazyComponent/index.tsx#LazyComponent"] = { docgenInfo: LazyComponent.__docgenInfo, name: "LazyComponent", path: "../ui_utils/src/components/LazyComponent/index.tsx#LazyComponent" };
}
...
;// ../ui_utils/src/components/LazyComponent/stories/LoadingSquare.tsx


const LoadingSquare = () => /*#__PURE__*/react.createElement(StoryStack/* default */.A, {
  alignItems: "center",
  justifyContent: "center",
  padding: "10",
  backgroundColor: "blue_700"
}, "Loading...");
/* harmony default export */ const stories_LoadingSquare = (LoadingSquare);
;// ../ui_utils/src/components/LazyComponent/stories/index.stories.tsx
...
const WithPlaceholder = {
  ...
  parameters: {
    docs: {
      source: {
        code: "const [shouldImport, setShouldImport] = useState(false);\n\nuseEffect(() => {\n  setTimeout(() => setShouldImport(true), 5000);\n});\n\nconst lazyImport = () => import(/* webpackChunkName: 'LoadedSquare' */ './LoadedSquare');\nconst onError = (error) => logger.error(error, { description: 'Failed to lazy load LoadedSquare' });\n\nreturn (\n  <LazyComponent\n    lazyImport={lazyImport}\n    shouldImport={shouldImport}\n    placeholder={<LoadingSquare />}\n    onError={onError}\n  />\n);"
      }
    }
  },
  render: () => {
    const [shouldImport, setShouldImport] = (0,react.useState)(false);
    (0,react.useEffect)(() => {
      setTimeout(() => setShouldImport(true), 5000);
    });
    const lazyImport = () => __webpack_require__.e(/* import() | LoadedSquare */ 6141).then(__webpack_require__.bind(__webpack_require__, "../ui_utils/src/components/LazyComponent/stories/LoadedSquare.tsx"));
    const onError = error => emitter/* default */.A.error(error, {
      description: 'Failed to lazy load LoadedSquare'
    });
    return /*#__PURE__*/react.createElement(components_LazyComponent, {
      lazyImport: lazyImport,
      shouldImport: shouldImport,
      placeholder: /*#__PURE__*/react.createElement(stories_LoadingSquare, null),
      onError: onError
    });
  }
};
const WithComponentProps = {
  ...
  parameters: {
    docs: {
      source: {
        code: "const [isOpen, setIsOpen] = useState(false);\n\nconst lazyImport = () => import(/* webpackChunkName: 'LoadedSquareWithProps' */ './LoadedSquareWithProps');\nconst onError = (error) => logger.error(error, { description: 'Failed to lazy load LoadedSquareWithProps' });\n\nreturn (\n  <>\n    <LazyComponent<LoadedSquareProps>\n      lazyImport={lazyImport}\n      shouldImport={isOpen}\n      componentProps={{\n        isOpen,\n        onClick: () => setIsOpen(false),\n      }}\n      onError={onError}\n    />\n    {!isOpen && <Button onClick={() => setIsOpen(true)}>Show square</Button>}\n  </>\n);"
      }
    }
  },
  render: () => {
    const [isOpen, setIsOpen] = (0,react.useState)(false);
    const lazyImport = () => __webpack_require__.e(/* import() | LoadedSquareWithProps */ 2593).then(__webpack_require__.bind(__webpack_require__, "../ui_utils/src/components/LazyComponent/stories/LoadedSquareWithProps.tsx"));
    const onError = error => emitter/* default */.A.error(error, {
      description: 'Failed to lazy load LoadedSquareWithProps'
    });
    return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(components_LazyComponent, {
      lazyImport: lazyImport,
      shouldImport: isOpen,
      componentProps: {
        isOpen,
      ...
      onError: onError
    }), !isOpen && /*#__PURE__*/react.createElement(Button/* default */.A, {
      onClick: () => setIsOpen(true)
    }, "Show square"));
  }
};
const meta = {
  title: 'UI-Utils/LazyComponent',
  component: components_LazyComponent
};
...
WithPlaceholder.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: "{\n  tags: ['sidebar-ignore'],\n  parameters: {\n    docs: {\n      source: {\n        code: `const [shouldImport, setShouldImport] = useState(false);\n\nuseEffect(() => {\n  setTimeout(() => setShouldImport(true), 5000);\n});\n\nconst lazyImport = () => import(/* webpackChunkName: 'LoadedSquare' */ './LoadedSquare');\nconst onError = (error) => logger.error(error, { description: 'Failed to lazy load LoadedSquare' });\n\nreturn (\n  <LazyComponent\n    lazyImport={lazyImport}\n    shouldImport={shouldImport}\n    placeholder={<LoadingSquare />}\n    onError={onError}\n  />\n);`\n      }\n    }\n  },\n  render: () => {\n    const [shouldImport, setShouldImport] = useState(false);\n    useEffect(() => {\n      setTimeout(() => setShouldImport(true), 5000);\n    });\n    const lazyImport = () => import(/* webpackChunkName: 'LoadedSquare' */'./LoadedSquare');\n    const onError = error => logger.error(error, {\n      description: 'Failed to lazy load LoadedSquare'\n    });\n    return <LazyComponent lazyImport={lazyImport} shouldImport={shouldImport} placeholder={<LoadingSquare />} onError={onError} />;\n  }\n}",
      ...WithPlaceholder.parameters?.docs?.source
    }
  }
};
WithComponentProps.parameters = {
  ...WithComponentProps.parameters,
  docs: {
    ...WithComponentProps.parameters?.docs,
    source: {
      originalSource: "{\n  tags: ['sidebar-ignore'],\n  parameters: {\n    docs: {\n      source: {\n        code: `const [isOpen, setIsOpen] = useState(false);\n\nconst lazyImport = () => import(/* webpackChunkName: 'LoadedSquareWithProps' */ './LoadedSquareWithProps');\nconst onError = (error) => logger.error(error, { description: 'Failed to lazy load LoadedSquareWithProps' });\n\nreturn (\n  <>\n    <LazyComponent<LoadedSquareProps>\n      lazyImport={lazyImport}\n      shouldImport={isOpen}\n      componentProps={{\n        isOpen,\n        onClick: () => setIsOpen(false),\n      }}\n      onError={onError}\n    />\n    {!isOpen && <Button onClick={() => setIsOpen(true)}>Show square</Button>}\n  </>\n);`\n      }\n    }\n  },\n  render: () => {\n    const [isOpen, setIsOpen] = useState(false);\n    const lazyImport = () => import(/* webpackChunkName: 'LoadedSquareWithProps' */'./LoadedSquareWithProps');\n    const onError = error => logger.error(error, {\n      description: 'Failed to lazy load LoadedSquareWithProps'\n    });\n    return <>\n        <LazyComponent<LoadedSquareProps> lazyImport={lazyImport} shouldImport={isOpen} componentProps={{\n        isOpen,\n        onClick: () => setIsOpen(false)\n      }} onError={onError} />\n        {!isOpen && <Button onClick={() => setIsOpen(true)}>Show square</Button>}\n      </>;\n  }\n}",
      ...WithComponentProps.parameters?.docs?.source
    }
  }
};;const __namedExportsOrder = ["WithPlaceholder","WithComponentProps"];
...
//# sourceMappingURL=components-LazyComponent-stories-Docs-mdx.fa6c12e5.iframe.bundle.js.map