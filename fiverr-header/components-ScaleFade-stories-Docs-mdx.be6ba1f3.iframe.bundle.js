"use strict";
(self["webpackChunk_fiverr_private_penta_storybook"] = self["webpackChunk_fiverr_private_penta_storybook"] || []).push([[7654],{
...
/***/ "../transition/src/components/ScaleFade/stories/Docs.mdx":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _index_stories__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("../transition/src/components/ScaleFade/stories/index.stories.tsx");
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_storybook_blocks__WEBPACK_IMPORTED_MODULE_3__/* .Meta */ .W8, {
      ...
      children: "Animation component for scale & fade effects"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.pre, {
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        className: "language-tsx",
        children: "import { ScaleFade } from '@fiverr-private/transition';\n"
      })
      ...
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        className: "language-tsx",
        children: "This content will be used in the examples below:\n\nconst ContentToAnimate = forwardRef<HTMLElement, Types.BoxType>((props, ref) => (\n  <StoryStack ref={ref} backgroundColor=\"blue_700\" maxWidth=\"400px\" boxSizing=\"borderBox\" {...props}>\n    <StoryStack padding=\"6\" color=\"white\">{contentText}</StoryStack>\n  </StoryStack>\n));\n"
      })
...
/***/ "../transition/src/components/ScaleFade/stories/index.stories.tsx":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.d(__webpack_exports__, {
  CustomInitialScale: () => (/* binding */ CustomInitialScale),
  CustomTiming: () => (/* binding */ CustomTiming),
  InitialIn: () => (/* binding */ InitialIn),
  Primary: () => (/* binding */ Primary),
  UnmountOnExit: () => (/* binding */ UnmountOnExit),
  WithoutReverseAnimation: () => (/* binding */ WithoutReverseAnimation),
...
;// ../transition/src/components/ScaleFade/variants.ts


const getTiming = function (key) {
  ...
  return {
    duration: constants/* DURATION */.ft[(0,utils/* getValueOrField */.F)(duration, key)],
    ease: constants/* EASING */.Ux[(0,utils/* getValueOrField */.F)(easing, key)],
    delay: constants/* DURATION */.ft[(0,utils/* getValueOrField */.F)(delay, key)]
  };
};
const variants = {
  enter: _ref => {
...
/* harmony default export */ const ScaleFade_variants = (variants);
;// ../transition/src/components/ScaleFade/index.tsx
...
const ScaleFade = _ref => {
  ...
  const transitionConfig = isOpen ? ScaleFade_variants.enter(custom) : ScaleFade_variants.exit(custom);
  const {
    getEventsHandler
  ...
  return /*#__PURE__*/react.createElement(es/* Animate */.i, {
    ...
    start: ScaleFade_variants.exit(custom),
    ...
    leave: _objectSpread(_objectSpread({}, ScaleFade_variants.exit(custom)), getEventsHandler('leave'))
  }, _ref2 => {
    let {
        scale
      } = _ref2,
    ...
    return (0,render_children/* renderChildren */.s)(children, {
      style: _objectSpread(_objectSpread(_objectSpread({}, children.props.style || {}), rest), {}, {
        display: rest.opacity === 0 ? 'none' : undefined,
        transform: isOpen || reverse ? "scale(".concat(scale, ")") : 'scale(1)'
      })
    });
  });
};
ScaleFade.displayName = 'ScaleFade';
/* harmony default export */ const components_ScaleFade = (ScaleFade);
try {
    // @ts-ignore
    ScaleFade.displayName = "ScaleFade";
    // @ts-ignore
    ScaleFade.__docgenInfo = { "description": "", "displayName": "ScaleFade", "props": { "in": { "defaultValue": null, "description": "Whether the component is shown", "name": "in", "required": false, "type": { "name": "boolean", "value": [{ "value": "false" }, { "value": "true" }] } }, "unmountOnExit": { "defaultValue": null, "description": "When true, removing the component from the DOM after exit animation", "name": "unmountOnExit", "required": false, "type": { "name": "boolean", "value": [{ "value": "false" }, { "value": "true" }] } }, "onAnimationStart": { "defaultValue": null, "description": "Event on animation start", "name": "onAnimationStart", "required": false, "type": { "name": "() => void" } }, "onAnimationEnd": { "defaultValue": null, "description": "Event on animation end", "name": "onAnimationEnd", "required": false, "type": { "name": "() => void" } }, "initialScale": { "defaultValue": { value: "0.95" }, "description": "Initial scale to start growing from", "name": "initialScale", "required": false, "type": { "name": "number" } }, "initialOpacity": { "defaultValue": { value: "0" }, "description": "Initial opacity to start from", "name": "initialOpacity", "required": false, "type": { "name": "number" } }, "reverse": { "defaultValue": { value: "true" }, "description": "Whether to apply exit animation", "name": "reverse", "required": false, "type": { "name": "boolean", "value": [{ "value": "false" }, { "value": "true" }] } }, "delay": { "defaultValue": null, "description": "Custom animation delay", "name": "delay", "required": false, "type": { "name": "enum", "value": [{ "value": "\"fast1\"" }, { "value": "\"fast2\"" }, { "value": "\"fast3\"" }, { "value": "\"moderate1\"" }, { "value": "\"moderate2\"" }, { "value": "\"moderate3\"" }, { "value": "\"slow1\"" }, { "value": "\"slow2\"" }, { "value": "\"slow3\"" }] } }, "duration": { "defaultValue": { value: "fast2" }, "description": "Custom animation duration", "name": "duration", "required": false, "type": { "name": "enum", "value": [{ "value": "\"fast1\"" }, { "value": "\"fast2\"" }, { "value": "\"fast3\"" }, { "value": "\"moderate1\"" }, { "value": "\"moderate2\"" }, { "value": "\"moderate3\"" }, { "value": "\"slow1\"" }, { "value": "\"slow2\"" }, { "value": "\"slow3\"" }] } }, "easing": { "defaultValue": { value: "easeInOut" }, "description": "Custom animation easing", "name": "easing", "required": false, "type": { "name": "enum", "value": [{ "value": "\"linear\"" }, { "value": "\"easeIn\"" }, { "value": "\"easeOut\"" }, { "value": "\"easeInOut\"" }] } } } };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../transition/src/components/ScaleFade/index.tsx#ScaleFade"] = { docgenInfo: ScaleFade.__docgenInfo, name: "ScaleFade", path: "../transition/src/components/ScaleFade/index.tsx#ScaleFade" };
}
...
const Demo = args => {
  ...
  }, "Toggle Animation"), /*#__PURE__*/react.createElement(components_ScaleFade, _extends({}, args, {
    in: open
...
const CustomInitialScale = {
  tags: ['sidebar-ignore'],
  parameters: {
    docs: {
      source: {
        code: "const [open, setOpen] = useState(false);\n\nreturn (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Animation</Button>\n    <ScaleFade in={open} initialScale={0.5}>\n      <ContentToAnimate />\n    </ScaleFade>\n  </>\n);"
      }
    }
  },
  args: {
...
const WithoutReverseAnimation = {
  tags: ['sidebar-ignore'],
  parameters: {
    docs: {
      source: {
        code: "const [open, setOpen] = useState(false);\n\nreturn (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Animation</Button>\n    <ScaleFade in={open} reverse={false}>\n      <ContentToAnimate />\n    </ScaleFade>\n  </>\n);"
      }
    }
  },
  args: {
...
const CustomTiming = {
  ...
  parameters: {
    docs: {
      ...
      source: {
        code: "const [open, setOpen] = useState(false);\n\nreturn (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Animation</Button>\n    <ScaleFade {...args} in={open} easing={{ enter: 'easeIn', exit: 'easeOut' }} duration={{ enter: 'slow1', exit: 'moderate2' }} delay=\"moderate1\">\n      <ContentToAnimate />\n    </ScaleFade>\n  </>\n);"
      }
    }
  },
  args: {
...
const meta = {
  ...
  component: components_ScaleFade,
...
CustomInitialScale.parameters = {
  ...CustomInitialScale.parameters,
  docs: {
    ...CustomInitialScale.parameters?.docs,
    source: {
      originalSource: "{\n  tags: ['sidebar-ignore'],\n  parameters: {\n    docs: {\n      source: {\n        code: `const [open, setOpen] = useState(false);\n\nreturn (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Animation</Button>\n    <ScaleFade in={open} initialScale={0.5}>\n      <ContentToAnimate />\n    </ScaleFade>\n  </>\n);`\n      }\n    }\n  },\n  args: {\n    initialScale: 0.5\n  }\n}",
      ...CustomInitialScale.parameters?.docs?.source
    }
  }
};
WithoutReverseAnimation.parameters = {
  ...WithoutReverseAnimation.parameters,
  docs: {
    ...WithoutReverseAnimation.parameters?.docs,
    source: {
      originalSource: "{\n  tags: ['sidebar-ignore'],\n  parameters: {\n    docs: {\n      source: {\n        code: `const [open, setOpen] = useState(false);\n\nreturn (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Animation</Button>\n    <ScaleFade in={open} reverse={false}>\n      <ContentToAnimate />\n    </ScaleFade>\n  </>\n);`\n      }\n    }\n  },\n  args: {\n    reverse: false\n  }\n}",
      ...WithoutReverseAnimation.parameters?.docs?.source
    }
  }
};
...
};;const __namedExportsOrder = ["Primary","UnmountOnExit","CustomInitialScale","WithoutReverseAnimation","InitialIn","CustomTiming"];
...
//# sourceMappingURL=components-ScaleFade-stories-Docs-mdx.be6ba1f3.iframe.bundle.js.map