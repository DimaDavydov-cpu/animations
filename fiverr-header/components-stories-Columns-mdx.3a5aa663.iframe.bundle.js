"use strict";
(self["webpackChunk_fiverr_private_penta_storybook"] = self["webpackChunk_fiverr_private_penta_storybook"] || []).push([[77,750,1077,1923,2099,2278,2937,3594,3601,3666,4367,5502,6151,7394,7770,8124,8135,8815,9610,9630],{
...
/***/ "../table/src/components/stories/Columns.mdx":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_storybook_blocks__WEBPACK_IMPORTED_MODULE_3__/* .Meta */ .W8, {
      ...
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        className: "language-jsx",
        children: " {\n    accessorKey: 'biography',\n    header: () => <>Biography</>,\n    cell: () => (\n      <Tooltip appendToBody as=\"div\" content={biography}>\n        {biography}\n      </Tooltip>\n    ),\n  }\n"
      })
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.h2, {
      id: "select",
      children: "Select"
      ...
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        className: "language-jsx",
        children: "import { TableActionsCell, TableActionsCellFloating } from '@fiverr-private/table';\n"
      })
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.pre, {
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        className: "language-jsx",
        children: "{\n    accessorKey: 'actions',\n    header: () => <></>,\n    cell: (info) => (\n      <TableActionsCell cell={info.cell} isRowHovered={info.isHovered}>\n        <Dropdown>\n          <DropdownAnchor embed>\n            <IconButton size=\"sm\" shape=\"circle\" variant=\"ghost\" aria-label=\"\">\n              <EllipsisIcon></EllipsisIcon>\n            </IconButton>\n          </DropdownAnchor>\n          <DropdownContent appendToBody>\n            <DropdownMenu>\n              <MenuItem>Option 1</MenuItem>\n              <MenuItem>Option 2</MenuItem>\n              <MenuItem>Option 3</MenuItem>\n            </DropdownMenu>\n          </DropdownContent>\n        </Dropdown>\n        <TableActionsCellFloating>\n          <Button size=\"sm\">Button</Button>\n        </TableActionsCellFloating>\n      </TableActionsCell>\n    ),\n  }\n"
      })
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.h2, {
      id: "size",
      children: "Size"
      ...
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        className: "language-jsx",
        children: "  {\n    accessorKey: 'status',\n    header: 'Status',\n    enableColumnFilter: true,\n    filterFn: (row, columnId, filterStatuses) => {\n      const status = row.getValue(columnId);\n\n      return filterStatuses.includes(status);\n    },\n    cell: (info) => info.getValue() === 'completed' ? <CompletedStatus/> : <InProgressStatus/>,\n  },\n"
      })
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.h3, {
      id: "filter-func",
      children: "Filter func"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.pre, {
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        className: "language-jsx",
        children: "  {\n    accessorKey: 'status',\n    header: 'Status',\n    enableColumnFilter: true,\n    filterFn: (row, columnId, filterStatuses) => {\n      const status = row.getValue(columnId);\n\n      return filterStatuses.includes(status);\n    },\n    cell: (info) => info.getValue() === 'completed' ? <CompletedStatus/> : <InProgressStatus/>,\n  },\n"
...
//# sourceMappingURL=components-stories-Columns-mdx.3a5aa663.iframe.bundle.js.map