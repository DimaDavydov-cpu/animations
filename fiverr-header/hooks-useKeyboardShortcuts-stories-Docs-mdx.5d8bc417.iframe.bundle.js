(self["webpackChunk_fiverr_private_penta_storybook"] = self["webpackChunk_fiverr_private_penta_storybook"] || []).push([[2449,9442],{
...
/***/ "../hooks/src/hooks/useKeyboardShortcuts/stories/Docs.mdx":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _index_stories__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("../hooks/src/hooks/useKeyboardShortcuts/stories/index.stories.tsx");
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_storybook_blocks__WEBPACK_IMPORTED_MODULE_3__/* .Meta */ .W8, {
      ...
      children: "A hook to capture keyboard actions"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.pre, {
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        className: "language-tsx",
        children: "import { useKeyboardShortcuts } from '@fiverr-private/hooks';\n"
      })
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.thead, {
        ...
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.tr, {
          children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.td, {
            ...
            children: "The shortcuts to listen to"
          }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.td, {
            children: "-"
          })]
          ...
          children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.td, {
            ...
            children: "A function that should return the HTMLElement target to listen to (defaults to document body)"
          }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.td, {
          ...
          children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.td, {
            ...
            children: "Whether to useCapture on the key down / up listeners or not"
          }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.td, {
            children: "false"
          })]
        })]
...
/***/ "../hooks/src/hooks/useKeyboardShortcuts/stories/index.stories.tsx":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  AllKeysConsumer: () => (/* binding */ AllKeysConsumer),
  GlobalConsumer: () => (/* binding */ GlobalConsumer),
  RefConsumer: () => (/* binding */ RefConsumer),
  RepeatedKeyConsumer: () => (/* binding */ RepeatedKeyConsumer),
...
;// ../hooks/src/hooks/useKeyboardShortcuts/constants.ts
...
const ANY_KEY = '*';
;// ../hooks/src/hooks/useKeyboardShortcuts/utils.ts
...
const shouldTrigger = (shortcuts, keys) => keys.length === shortcuts.length && keys.every((key, index) => key === shortcuts[index]);
...
;// ../hooks/src/hooks/useKeyboardShortcuts/index.ts
...
const useKeyboardShortcuts = function (shortcuts, getTarget) {
...
const Demo = _ref => {
  ...
  const [numOfEvents, setNumOfEvents] = (0,react.useState)(0);
  const handler = (0,react.useCallback)((event, options, numOfEvents, shortcut) => {
    if (options.allowRepeat) {
      setNumOfEvents(numOfEvents + 1);
      setLogs(["*** Number of fired events = ".concat(numOfEvents + 1)]);
    } else {
      const newLog = Array.isArray(shortcut) ? "*** Keys ".concat(shortcut.map(key => (0,lodash.capitalize)(key)).join(' + '), " pressed ***") : "**** Key \"".concat((0,lodash.capitalize)(event.key), "\" is pressed ***");
      setLogs(logs => [...logs, newLog]);
    }
  }, []);

  // eslint-disable-next-line react-hooks/exhaustive-deps
  const handlerThrottled = (0,react.useMemo)(() => (0,lodash.throttle)(handler, throttleDelay), [throttleDelay]);
  hooks_useKeyboardShortcuts(shortcuts.map(shortcut => ({
    trigger: shortcut,
    handler: event => {
      event.preventDefault();
      const runHandler = throttleDelay ? handlerThrottled : handler;
      runHandler(event, options, numOfEvents, shortcut);
    }
  })), withTarget ? () => ref.current : undefined, options);
  return /*#__PURE__*/react.createElement(StoryStack/* default */.A, {
    ref: withTarget ? ref : undefined,
    tabIndex: withTarget ? -1 : undefined,
    height: "300px",
    width: "300px",
    direction: "column",
    borderWidth: "sm",
    ...
    borderColor: "border",
    overflowY: "scroll"
  }, logs.map((log, index) => /*#__PURE__*/react.createElement(StoryText/* default */.A, {
    key: index
  }, log)));
};
const GlobalConsumer = {
  parameters: {
    docs: {
      description: {
        story: "Press on 'f' / 'shift+e' / 'space' in order to trigger one of the handlers"
      },
      source: {
        code: "const [logs, setLogs] = useState<string[]>([]);\n\nuseKeyboardShortcuts([\n  {\n    trigger: ['shift', 'e'],\n    handler: () => setLogs([...logs, '*** Keys \"Shift + E\" pressed ***']),\n  },\n  {\n    trigger: 'f',\n    handler: () => setLogs([...logs, '**** Key \"F\" is pressed ***']),\n  },\n  {\n    trigger: 'space',\n    handler: () => setLogs([...logs, '**** Key \" \" is pressed ***']),\n  },\n]);"
      }
    }
  },
  args: {
    shortcuts: [['shift', 'e'], 'f', 'space']
  },
  tags: ['sidebar-ignore']
};
const RefConsumer = {
  parameters: {
    docs: {
      description: {
        story: "Click on 'k' only after focusing the black target"
      },
      source: {
        code: "const ref = useRef(null);\nconst [logs, setLogs] = useState<string[]>([]);\n\nuseKeyboardShortcuts(\n  [\n    {\n      trigger: 'k',\n      handler: () => setLogs([...logs, \"**** Key K is pressed ***\"]),\n    },\n  ],\n  () => ref.current\n);"
      }
    }
  },
  args: {
...
const RepeatedKeyConsumer = {
  parameters: {
    docs: {
      description: {
        story: "Press on 'Arrow Down' and keep pressing. Event will be repeated and throttled."
      },
      source: {
        code: "import { throttle } from 'lodash';\n\nconst ref = useRef(null);\nconst [logs, setLogs] = useState<string[]>([]);\nconst [numOfEvents, setNumOfEvents] = useState(0);\n\nconst handler = useCallback((numOfEvents) => {\n    setNumOfEvents(numOfEvents + 1);\n    setLogs([\"*** Number of fired events = \" + numOfEvents + 1])\n}, []);\n\nconst handlerThrottled = useMemo(() => throttle(handler, 200), []);\n\nuseKeyboardShortcuts(\n  [\n    {\n      trigger: 'arrowdown',\n      handler: () => {\n        handlerThrottled(numOfEvents);\n      },\n    },\n  ],\n  () => ref.current\n);"
      }
    }
  },
  args: {
...
const AllKeysConsumer = {
  parameters: {
    docs: {
      description: {
        story: 'Press on any key in order to trigger the handler'
      },
      source: {
        code: "const [logs, setLogs] = useState<string[]>([]);\n\nuseKeyboardShortcuts([\n  {\n    trigger: '*',\n    handler: (event) => setLogs([...logs, \"**** Key \" + capitalize(event.key) \" is pressed ***\"]),\n  },\n]);"
      }
    }
  },
  args: {
...
GlobalConsumer.parameters = {
  ...GlobalConsumer.parameters,
  docs: {
    ...GlobalConsumer.parameters?.docs,
    source: {
      originalSource: "{\n  parameters: {\n    docs: {\n      description: {\n        story: \"Press on 'f' / 'shift+e' / 'space' in order to trigger one of the handlers\"\n      },\n      source: {\n        code: `const [logs, setLogs] = useState<string[]>([]);\n\nuseKeyboardShortcuts([\n  {\n    trigger: ['shift', 'e'],\n    handler: () => setLogs([...logs, '*** Keys \"Shift + E\" pressed ***']),\n  },\n  {\n    trigger: 'f',\n    handler: () => setLogs([...logs, '**** Key \"F\" is pressed ***']),\n  },\n  {\n    trigger: 'space',\n    handler: () => setLogs([...logs, '**** Key \" \" is pressed ***']),\n  },\n]);`\n      }\n    }\n  },\n  args: {\n    shortcuts: [['shift', 'e'], 'f', 'space']\n  },\n  tags: ['sidebar-ignore']\n}",
      ...GlobalConsumer.parameters?.docs?.source
    }
  }
};
RefConsumer.parameters = {
  ...RefConsumer.parameters,
  docs: {
    ...RefConsumer.parameters?.docs,
    source: {
      originalSource: "{\n  parameters: {\n    docs: {\n      description: {\n        story: \"Click on 'k' only after focusing the black target\"\n      },\n      source: {\n        code: `const ref = useRef(null);\nconst [logs, setLogs] = useState<string[]>([]);\n\nuseKeyboardShortcuts(\n  [\n    {\n      trigger: 'k',\n      handler: () => setLogs([...logs, \"**** Key K is pressed ***\"]),\n    },\n  ],\n  () => ref.current\n);`\n      }\n    }\n  },\n  args: {\n    shortcuts: ['k'],\n    withTarget: true\n  },\n  tags: ['sidebar-ignore']\n}",
      ...RefConsumer.parameters?.docs?.source
    }
  }
};
RepeatedKeyConsumer.parameters = {
  ...RepeatedKeyConsumer.parameters,
  docs: {
    ...RepeatedKeyConsumer.parameters?.docs,
    source: {
      originalSource: "{\n  parameters: {\n    docs: {\n      description: {\n        story: \"Press on 'Arrow Down' and keep pressing. Event will be repeated and throttled.\"\n      },\n      source: {\n        code: `import { throttle } from 'lodash';\n\nconst ref = useRef(null);\nconst [logs, setLogs] = useState<string[]>([]);\nconst [numOfEvents, setNumOfEvents] = useState(0);\n\nconst handler = useCallback((numOfEvents) => {\n    setNumOfEvents(numOfEvents + 1);\n    setLogs([\"*** Number of fired events = \" + numOfEvents + 1])\n}, []);\n\nconst handlerThrottled = useMemo(() => throttle(handler, 200), []);\n\nuseKeyboardShortcuts(\n  [\n    {\n      trigger: 'arrowdown',\n      handler: () => {\n        handlerThrottled(numOfEvents);\n      },\n    },\n  ],\n  () => ref.current\n);`\n      }\n    }\n  },\n  args: {\n    shortcuts: ['arrowdown'],\n    withTarget: true,\n    options: {\n      allowRepeat: true\n    },\n    throttleDelay: 200\n  },\n  tags: ['sidebar-ignore']\n}",
      ...RepeatedKeyConsumer.parameters?.docs?.source
    }
  }
};
AllKeysConsumer.parameters = {
  ...AllKeysConsumer.parameters,
  docs: {
    ...AllKeysConsumer.parameters?.docs,
    source: {
      originalSource: "{\n  parameters: {\n    docs: {\n      description: {\n        story: 'Press on any key in order to trigger the handler'\n      },\n      source: {\n        code: `const [logs, setLogs] = useState<string[]>([]);\n\nuseKeyboardShortcuts([\n  {\n    trigger: '*',\n    handler: (event) => setLogs([...logs, \"**** Key \" + capitalize(event.key) \" is pressed ***\"]),\n  },\n]);`\n      }\n    }\n  },\n  args: {\n    shortcuts: ['*']\n  },\n  tags: ['sidebar-ignore']\n}",
      ...AllKeysConsumer.parameters?.docs?.source
    }
  }
};;const __namedExportsOrder = ["GlobalConsumer","RefConsumer","RepeatedKeyConsumer","AllKeysConsumer"];
...
//# sourceMappingURL=hooks-useKeyboardShortcuts-stories-Docs-mdx.5d8bc417.iframe.bundle.js.map