"use strict";
(self["webpackChunk_fiverr_private_penta_storybook"] = self["webpackChunk_fiverr_private_penta_storybook"] || []).push([[5453],{
...
/***/ "../transition/src/components/Collapse/stories/index.stories.tsx":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  AutoEndingHeightWithDynamicContent: () => (/* binding */ AutoEndingHeightWithDynamicContent),
  ConstantEndingHeight: () => (/* binding */ ConstantEndingHeight),
  CustomTiming: () => (/* binding */ CustomTiming),
  InitialIn: () => (/* binding */ InitialIn),
  Primary: () => (/* binding */ Primary),
  UnmountOnExit: () => (/* binding */ UnmountOnExit),
  UnmountOnExitAndEndingHeight: () => (/* binding */ UnmountOnExitAndEndingHeight),
  WithStartingHeight: () => (/* binding */ WithStartingHeight),
  WithoutOpacityAnimation: () => (/* binding */ WithoutOpacityAnimation),
...
;// ../transition/src/components/Collapse/variants.ts
function ownKeys(e, r) {
  var t = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var o = Object.getOwnPropertySymbols(e);
...
;// ../transition/src/components/Collapse/constants.ts
const UPDATE_DYNAMIC_CONTENT_TIMEOUT = 50;
const UNIQUE_ATTRIBUTES = ['id', 'name', 'for'];
;// ../transition/src/components/Collapse/utils.ts
...
;// ../transition/src/components/Collapse/index.tsx
...
try {
    ...
    Collapse.displayName = "Collapse";
    // @ts-ignore
    Collapse.__docgenInfo = { "description": "", "displayName": "Collapse", "props": { "in": { "defaultValue": null, "description": "Whether the component is shown", "name": "in", "required": false, "type": { "name": "boolean", "value": [{ "value": "false" }, { "value": "true" }] } }, "unmountOnExit": { "defaultValue": null, "description": "When true, removing the component from the DOM after exit animation", "name": "unmountOnExit", "required": false, "type": { "name": "boolean", "value": [{ "value": "false" }, { "value": "true" }] } }, "onAnimationStart": { "defaultValue": null, "description": "Event on animation start", "name": "onAnimationStart", "required": false, "type": { "name": "() => void" } }, "onAnimationEnd": { "defaultValue": null, "description": "Event on animation end", "name": "onAnimationEnd", "required": false, "type": { "name": "() => void" } }, "animateOpacity": { "defaultValue": { value: "true" }, "description": "Whether to apply opacity animation during collapse state changes", "name": "animateOpacity", "required": false, "type": { "name": "boolean", "value": [{ "value": "false" }, { "value": "true" }] } }, "startingHeight": { "defaultValue": { value: "0" }, "description": "Define starting height in px for the content (useful for \"read more\" behavior)", "name": "startingHeight", "required": false, "type": { "name": "number" } }, "endingHeight": { "defaultValue": { value: "auto" }, "description": "Define ending height in px for the content or 'auto' for dynamic content\nWhen using 'auto', the child component of Collapse should support forwardRef and style prop.", "name": "endingHeight", "required": false, "type": { "name": "enum", "value": [{ "value": "number" }, { "value": "\"auto\"" }] } }, "delay": { "defaultValue": null, "description": "Custom animation delay", "name": "delay", "required": false, "type": { "name": "enum", "value": [{ "value": "\"fast1\"" }, { "value": "\"fast2\"" }, { "value": "\"fast3\"" }, { "value": "\"moderate1\"" }, { "value": "\"moderate2\"" }, { "value": "\"moderate3\"" }, { "value": "\"slow1\"" }, { "value": "\"slow2\"" }, { "value": "\"slow3\"" }] } }, "duration": { "defaultValue": { value: "moderate1" }, "description": "Custom animation duration", "name": "duration", "required": false, "type": { "name": "enum", "value": [{ "value": "\"fast1\"" }, { "value": "\"fast2\"" }, { "value": "\"fast3\"" }, { "value": "\"moderate1\"" }, { "value": "\"moderate2\"" }, { "value": "\"moderate3\"" }, { "value": "\"slow1\"" }, { "value": "\"slow2\"" }, { "value": "\"slow3\"" }] } }, "easing": { "defaultValue": { value: "easeInOut" }, "description": "Custom animation easing", "name": "easing", "required": false, "type": { "name": "enum", "value": [{ "value": "\"linear\"" }, { "value": "\"easeIn\"" }, { "value": "\"easeOut\"" }, { "value": "\"easeInOut\"" }] } } } };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../transition/src/components/Collapse/index.tsx#Collapse"] = { docgenInfo: Collapse.__docgenInfo, name: "Collapse", path: "../transition/src/components/Collapse/index.tsx#Collapse" };
}
...
const Demo = args => {
  ...
  }, "Toggle Animation"), /*#__PURE__*/react.createElement(components_Collapse, _extends({}, args, {
    in: open
  }), /*#__PURE__*/react.createElement(helpers/* ContentToAnimate */.Y, null)));
};
Demo.displayName = 'Demo';
const Primary = {
  tags: ['sidebar-ignore']
};
const ConstantEndingHeight = {
  tags: ['sidebar-ignore'],
  parameters: {
    docs: {
      description: {
        story: 'If you know the ending height of your element, set a constant value for better performance.'
      },
      source: {
        code: "const [open, setOpen] = useState(false);\n\nreturn (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Animation</Button>\n    <Collapse in={open} endingHeight={72}>\n      <ContentToAnimate />\n    </Collapse>\n  </>\n);"
      }
    }
  },
  args: {
...
const WithStartingHeight = {
  tags: ['sidebar-ignore'],
  parameters: {
    docs: {
      description: {
        story: 'Use-full for read-more sections.'
      },
      source: {
        code: "const [open, setOpen] = useState(false);\n\nreturn (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Animation</Button>\n    <Collapse in={open} startingHeight={40}>\n      <ContentToAnimate />\n    </Collapse>\n  </>\n);"
      }
    }
  },
  args: {
...
const UnmountOnExit = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'When using unmountOnExit & endingHeight="auto" (default), the collapse animation is disabled.'
      },
      source: {
...
const UnmountOnExitAndEndingHeight = {
  tags: ['sidebar-ignore'],
  parameters: {
    docs: {
      description: {
        story: 'When using unmountOnExit & endingHeight={numeric value}, the collapse animation is partially disabled.'
      },
      source: {
        code: "const [open, setOpen] = useState(false);\n\nreturn (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Animation</Button>\n    <Collapse in={open} unmountOnExit endingHeight={72}>\n      <ContentToAnimate />\n    </Collapse>\n  </>\n);"
      }
    }
  },
  args: {
...
const CustomTiming = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'All timing functions supporting single value or different value for enter or/and exit'
      },
      source: {
        code: "const [open, setOpen] = useState(false);\n\nreturn (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Animation</Button>\n    <Collapse in={open} easing={{ enter: 'easeIn', exit: 'easeOut' }} duration={{ enter: 'slow1', exit: 'moderate2' }} delay=\"moderate1\">\n      <ContentToAnimate />\n    </Collapse>\n  </>\n);"
      }
    }
  },
  args: {
...
const AutoEndingHeightWithDynamicContent = {
  tags: ['sidebar-ignore'],
  parameters: {
    docs: {
      source: {
        code: "const [mounted, setMounted] = useState(false);\nconst [open, setOpen] = useState(true);\nconst [showMore, setShowMore] = useState(false);\n\nconst collapseWithToggle = () => (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Collapse</Button>\n    <Collapse in={open} duration={'slow3'} endingHeight={'auto'}>\n      <StoryStack display=\"block\">\n        bla bla bla\n        <br />\n        <StoryStack display=\"block\" hidden={!showMore}>\n          nah nah nah\n          <br />\n        </StoryStack>\n        <StoryText fontWeight=\"bold\" decoration=\"underline\" cursor=\"pointer\" onClick={() => setShowMore(!showMore)}>\n          {showMore ? 'show less' : 'show more'}\n        </StoryText>\n      </StoryStack>\n    </Collapse>\n  </>\n);\n\nreturn (\n  <>\n    <Button onClick={() => setMounted(!mounted)}>Toggle Mount</Button>\n    <br />\n    {mounted && collapseWithToggle()}\n  </>\n);"
      }
    }
  },
  render: args => {
    ...
    const collapseWithToggle = () => /*#__PURE__*/react.createElement(StoryStack/* default */.A, {
      marginTop: "4",
      display: "block"
    }, /*#__PURE__*/react.createElement(Button/* default */.A, {
      onClick: () => setOpen(!open)
    }, "Toggle Collapse"), /*#__PURE__*/react.createElement(components_Collapse, _extends({}, args, {
      in: open,
      duration: 'slow3',
      endingHeight: 'auto'
    }), /*#__PURE__*/react.createElement(StoryStack/* default */.A, {
      display: "block"
    }, "bla bla bla", /*#__PURE__*/react.createElement("br", null), /*#__PURE__*/react.createElement(StoryStack/* default */.A, {
      display: "block",
      hidden: !showMore
    }, "nah nah nah", /*#__PURE__*/react.createElement("br", null)), /*#__PURE__*/react.createElement(StoryText/* default */.A, {
      fontWeight: "bold",
    ...
    }, "Toggle Mount"), /*#__PURE__*/react.createElement("br", null), mounted && collapseWithToggle());
  }
};
const meta = {
  title: 'Transition/Collapse',
  component: components_Collapse,
...
ConstantEndingHeight.parameters = {
  ...ConstantEndingHeight.parameters,
  docs: {
    ...ConstantEndingHeight.parameters?.docs,
    source: {
      originalSource: "{\n  tags: ['sidebar-ignore'],\n  parameters: {\n    docs: {\n      description: {\n        story: 'If you know the ending height of your element, set a constant value for better performance.'\n      },\n      source: {\n        code: `const [open, setOpen] = useState(false);\n\nreturn (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Animation</Button>\n    <Collapse in={open} endingHeight={72}>\n      <ContentToAnimate />\n    </Collapse>\n  </>\n);`\n      }\n    }\n  },\n  args: {\n    endingHeight: 72\n  }\n}",
      ...ConstantEndingHeight.parameters?.docs?.source
    }
  }
};
WithStartingHeight.parameters = {
  ...WithStartingHeight.parameters,
  docs: {
    ...WithStartingHeight.parameters?.docs,
    source: {
      originalSource: "{\n  tags: ['sidebar-ignore'],\n  parameters: {\n    docs: {\n      description: {\n        story: 'Use-full for read-more sections.'\n      },\n      source: {\n        code: `const [open, setOpen] = useState(false);\n\nreturn (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Animation</Button>\n    <Collapse in={open} startingHeight={40}>\n      <ContentToAnimate />\n    </Collapse>\n  </>\n);`\n      }\n    }\n  },\n  args: {\n    startingHeight: 40\n  }\n}",
      ...WithStartingHeight.parameters?.docs?.source
    }
  }
};
...
UnmountOnExitAndEndingHeight.parameters = {
  ...UnmountOnExitAndEndingHeight.parameters,
  docs: {
    ...UnmountOnExitAndEndingHeight.parameters?.docs,
    source: {
      originalSource: "{\n  tags: ['sidebar-ignore'],\n  parameters: {\n    docs: {\n      description: {\n        story: 'When using unmountOnExit & endingHeight={numeric value}, the collapse animation is partially disabled.'\n      },\n      source: {\n        code: `const [open, setOpen] = useState(false);\n\nreturn (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Animation</Button>\n    <Collapse in={open} unmountOnExit endingHeight={72}>\n      <ContentToAnimate />\n    </Collapse>\n  </>\n);`\n      }\n    }\n  },\n  args: {\n    unmountOnExit: true,\n    endingHeight: 72\n  }\n}",
      ...UnmountOnExitAndEndingHeight.parameters?.docs?.source
    }
  }
};
WithoutOpacityAnimation.parameters = {
  ...WithoutOpacityAnimation.parameters,
  docs: {
    ...WithoutOpacityAnimation.parameters?.docs,
    source: {
      originalSource: "{\n  tags: ['sidebar-ignore'],\n  parameters: {\n    docs: {\n      source: {\n        code: `const [open, setOpen] = useState(false);\n\nreturn (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Animation</Button>\n    <Collapse in={open} animateOpacity={false}>\n      <ContentToAnimate />\n    </Collapse>\n  </>\n);`\n      }\n    }\n  },\n  args: {\n    animateOpacity: false\n  }\n}",
      ...WithoutOpacityAnimation.parameters?.docs?.source
    }
  }
};
InitialIn.parameters = {
  ...InitialIn.parameters,
  docs: {
    ...InitialIn.parameters?.docs,
    source: {
      originalSource: "{\n  tags: ['sidebar-ignore'],\n  parameters: {\n    docs: {\n      source: {\n        code: `const [open, setOpen] = useState(true);\n\nreturn (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Animation</Button>\n    <Collapse in={open}>\n      <ContentToAnimate />\n    </Collapse>\n  </>\n);`\n      }\n    }\n  },\n  args: {\n    in: true\n  }\n}",
      ...InitialIn.parameters?.docs?.source
    }
  }
};
...
AutoEndingHeightWithDynamicContent.parameters = {
  ...AutoEndingHeightWithDynamicContent.parameters,
  docs: {
    ...AutoEndingHeightWithDynamicContent.parameters?.docs,
    source: {
      originalSource: "{\n  tags: ['sidebar-ignore'],\n  parameters: {\n    docs: {\n      source: {\n        code: `const [mounted, setMounted] = useState(false);\nconst [open, setOpen] = useState(true);\nconst [showMore, setShowMore] = useState(false);\n\nconst collapseWithToggle = () => (\n  <>\n    <Button onClick={() => setOpen(!open)}>Toggle Collapse</Button>\n    <Collapse in={open} duration={'slow3'} endingHeight={'auto'}>\n      <StoryStack display=\"block\">\n        bla bla bla\n        <br />\n        <StoryStack display=\"block\" hidden={!showMore}>\n          nah nah nah\n          <br />\n        </StoryStack>\n        <StoryText fontWeight=\"bold\" decoration=\"underline\" cursor=\"pointer\" onClick={() => setShowMore(!showMore)}>\n          {showMore ? 'show less' : 'show more'}\n        </StoryText>\n      </StoryStack>\n    </Collapse>\n  </>\n);\n\nreturn (\n  <>\n    <Button onClick={() => setMounted(!mounted)}>Toggle Mount</Button>\n    <br />\n    {mounted && collapseWithToggle()}\n  </>\n);`\n      }\n    }\n  },\n  render: args => {\n    const [mounted, setMounted] = useState(false);\n    const [open, setOpen] = useState(true);\n    const [showMore, setShowMore] = useState(false);\n    const collapseWithToggle = () => <StoryStack marginTop=\"4\" display=\"block\">\n        <Button onClick={() => setOpen(!open)}>Toggle Collapse</Button>\n        <Collapse {...args} in={open} duration={'slow3'} endingHeight={'auto'}>\n          <StoryStack display=\"block\">\n            bla bla bla\n            <br />\n            <StoryStack display=\"block\" hidden={!showMore}>\n              nah nah nah\n              <br />\n            </StoryStack>\n            <StoryText fontWeight=\"bold\" decoration=\"underline\" cursor=\"pointer\" onClick={() => setShowMore(!showMore)}>\n              {showMore ? 'show less' : 'show more'}\n            </StoryText>\n          </StoryStack>\n        </Collapse>\n      </StoryStack>;\n    return <>\n        <Button onClick={() => setMounted(!mounted)}>Toggle Mount</Button>\n        <br />\n        {mounted && collapseWithToggle()}\n      </>;\n  }\n}",
      ...AutoEndingHeightWithDynamicContent.parameters?.docs?.source
    }
  }
};;const __namedExportsOrder = ["Primary","ConstantEndingHeight","WithStartingHeight","UnmountOnExit","UnmountOnExitAndEndingHeight","WithoutOpacityAnimation","InitialIn","CustomTiming","AutoEndingHeightWithDynamicContent"];
...
//# sourceMappingURL=5453.baf6f440.iframe.bundle.js.map