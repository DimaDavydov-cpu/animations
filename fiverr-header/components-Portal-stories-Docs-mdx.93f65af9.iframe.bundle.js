(self["webpackChunk_fiverr_private_penta_storybook"] = self["webpackChunk_fiverr_private_penta_storybook"] || []).push([[1653,2812],{
...
/***/ "../ui_utils/src/components/Portal/stories/Docs.mdx":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _index_stories__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("../ui_utils/src/components/Portal/stories/index.stories.tsx");
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_storybook_blocks__WEBPACK_IMPORTED_MODULE_3__/* .Meta */ .W8, {
      ...
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.p, {
        children: "Portal provide a first-class way to render children into a DOM node that exists outside the DOM hierarchy of the\nparent component."
      })
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.pre, {
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        className: "language-tsx",
        children: "import { Portal } from '@fiverr-private/ui_utils';\n"
      })
...
/***/ "../ui_utils/src/components/Portal/stories/index.stories.tsx":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  AppendToElement: () => (/* binding */ AppendToElement),
...
;// ../ui_utils/src/components/Portal/hooks/useCreateRootDivElement/index.ts
...
;// ../ui_utils/src/components/Portal/index.tsx
function ownKeys(e, r) {
  var t = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var o = Object.getOwnPropertySymbols(e);
...
try {
    ...
    Portal.displayName = "Portal";
    // @ts-ignore
    Portal.__docgenInfo = { "description": "", "displayName": "Portal", "props": { "children": { "defaultValue": null, "description": "Any node that can be rendered.", "name": "children", "required": true, "type": { "name": "boolean", "value": [{ "value": "string" }, { "value": "number" }, { "value": "false" }, { "value": "true" }, { "value": "{}" }, { "value": "ReactElement<any, string | JSXElementConstructor<any>>" }, { "value": "Iterable<ReactNode>" }, { "value": "ReactPortal" }] } }, "containerClassName": { "defaultValue": null, "description": "Classname to apply to the div container.", "name": "containerClassName", "required": false, "type": { "name": "string" } }, "containerElement": { "defaultValue": null, "description": "Custom element to append the Portal children to.", "name": "containerElement", "required": false, "type": { "name": "HTMLElement" } }, "height": { "defaultValue": null, "description": "Custom element height.", "name": "height", "required": false, "type": { "name": "enum", "value": [{ "value": "string" }, { "value": "number" }] } } } };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../ui_utils/src/components/Portal/index.tsx#Portal"] = { docgenInfo: Portal.__docgenInfo, name: "Portal", path: "../ui_utils/src/components/Portal/index.tsx#Portal" };
}
...
const AppendToBody = {
  ...
  parameters: {
    docs: {
      source: {
        code: "const [opened, setOpened] = useState(false);\n\nreturn (\n  <StoryStack direction=\"column\" width=\"fit-content\">\n    <Button onClick={() => setOpened(!opened)}>Toggle</Button>\n    {opened && (\n      <Portal>\n        <StoryText>Portal</StoryText>\n      </Portal>\n    )}\n    {opened && <StoryText>Added - Check the Dom tree</StoryText>}\n  </StoryStack>\n);"
      }
    }
  },
  render: () => {
    ...
    }, "Toggle"), opened && /*#__PURE__*/react.createElement(components_Portal, null, /*#__PURE__*/react.createElement(StoryText/* default */.A, null, "Portal")), opened && /*#__PURE__*/react.createElement(StoryText/* default */.A, null, "Added - Check the Dom tree"));
  }
};
const AppendToElement = {
  ...
  parameters: {
    docs: {
      source: {
        code: "const [opened, setOpened] = useState(false);\nconst ref = useRef<HTMLElement>(null);\n\nreturn (\n  <StoryStack width=\"fit-content\" direction=\"column\">\n    <Button onClick={() => setOpened(!opened)}>Toggle</Button>\n    {opened && (\n      <Portal containerElement={ref.current}>\n        <StoryText>Portal</StoryText>\n      </Portal>\n    )}\n    <StoryStack ref={ref}></StoryStack>\n  </StoryStack>\n);"
      }
    }
  },
  render: () => {
    ...
    return /*#__PURE__*/react.createElement(StoryStack/* default */.A, {
      ...
      onClick: () => setOpened(!opened)
    }, "Toggle"), opened && /*#__PURE__*/react.createElement(components_Portal, {
      containerElement: ref.current
    }, /*#__PURE__*/react.createElement(StoryText/* default */.A, null, "Portal")), /*#__PURE__*/react.createElement(StoryStack/* default */.A, {
      ref: ref
    }));
  }
};
const meta = {
  title: 'UI-Utils/Portal',
  component: components_Portal
};
...
AppendToBody.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: "{\n  tags: ['sidebar-ignore'],\n  parameters: {\n    docs: {\n      source: {\n        code: `const [opened, setOpened] = useState(false);\n\nreturn (\n  <StoryStack direction=\"column\" width=\"fit-content\">\n    <Button onClick={() => setOpened(!opened)}>Toggle</Button>\n    {opened && (\n      <Portal>\n        <StoryText>Portal</StoryText>\n      </Portal>\n    )}\n    {opened && <StoryText>Added - Check the Dom tree</StoryText>}\n  </StoryStack>\n);`\n      }\n    }\n  },\n  render: () => {\n    const [opened, setOpened] = useState(false);\n    return <StoryStack direction=\"column\" width=\"fit-content\">\n        <Button onClick={() => setOpened(!opened)}>Toggle</Button>\n        {opened && <Portal>\n            <StoryText>Portal</StoryText>\n          </Portal>}\n        {opened && <StoryText>Added - Check the Dom tree</StoryText>}\n      </StoryStack>;\n  }\n}",
      ...AppendToBody.parameters?.docs?.source
    }
  }
};
AppendToElement.parameters = {
  ...AppendToElement.parameters,
  docs: {
    ...AppendToElement.parameters?.docs,
    source: {
      originalSource: "{\n  tags: ['sidebar-ignore'],\n  parameters: {\n    docs: {\n      source: {\n        code: `const [opened, setOpened] = useState(false);\nconst ref = useRef<HTMLElement>(null);\n\nreturn (\n  <StoryStack width=\"fit-content\" direction=\"column\">\n    <Button onClick={() => setOpened(!opened)}>Toggle</Button>\n    {opened && (\n      <Portal containerElement={ref.current}>\n        <StoryText>Portal</StoryText>\n      </Portal>\n    )}\n    <StoryStack ref={ref}></StoryStack>\n  </StoryStack>\n);`\n      }\n    }\n  },\n  render: () => {\n    const [opened, setOpened] = useState(false);\n    const ref = useRef<HTMLElement>(null);\n    return <StoryStack width=\"fit-content\" direction=\"column\">\n        <Button onClick={() => setOpened(!opened)}>Toggle</Button>\n        {opened && <Portal containerElement={ref.current}>\n            <StoryText>Portal</StoryText>\n          </Portal>}\n        <StoryStack ref={ref}></StoryStack>\n      </StoryStack>;\n  }\n}",
      ...AppendToElement.parameters?.docs?.source
    }
  }
};;const __namedExportsOrder = ["AppendToBody","AppendToElement"];
...
//# sourceMappingURL=components-Portal-stories-Docs-mdx.93f65af9.iframe.bundle.js.map